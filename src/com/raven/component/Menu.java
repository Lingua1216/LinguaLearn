...
public class Menu extends PanelTransparent {
    ...
    public void initMenuItem() {
        ...
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")),"LESSON CONTENT", "CHINESE/MANDARIN", "JAPANESE/NIHONGGO"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/5.png")), "PROGRESS TRACKING", "Track Achievements"));

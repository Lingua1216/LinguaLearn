...
import com.raven.form.menu_2;
import com.raven.form.menu_3;

import com.raven.form.track;
...
public void setMainPanel(JPanel panel) {
    main.showForm(panel); // Use the existing `showForm` method from `MainForm`
}
    private void init() {
        main = new MainForm();
        ...
        // Handle USER MANAGEMENT menu (index 1)
        if (menuIndex == 1) {
            if (subMenuIndex == 0) {
                main.showForm(new menu_2());
                 return;
            }
        }
        if (menuIndex == 1) {
            if (subMenuIndex == 1) {
                main.showForm(new menu_3());
                return;
               }}
